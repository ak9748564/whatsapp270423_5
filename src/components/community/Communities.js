        ...
        <div className="flex flex-col h-screen">
            <div className="h-[108px] bg-[#A52729] flex flex-col justify-end">
                <div className="h-[54px] w-full flex items-center">
                    <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="fill-[#ffffffe6] mx-6 cursor-pointer" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24" onClick={props.communitiesFalse}>
            ...
            <div className="new_chats_scroll grow shrink  overflow-y-scroll bg-[#F0F2F5]">
                    ...
                    <div className="w-full mt-10">
                        <div className="flex items-center justify-between w-full border-b-2 border-[#667781]">
                            <div className="w-full relative">
                                ...
                                <input type="text" className="w-full h-[20px] my-2 outline-none" placeholder="Group Subject" onInput={(event)=>setCommunityName(event.target.value)} onChange={(event)=>setCommunityName(event.target.value)}/>
                            </div>
                ...
                <div className={ communityName === "" ? "hidden" : "w-full flex justify-center pt-[24px] pb-[40px]" }>
                    <div className="rounded-full bg-[#00A884] flex items-center justify-center h-[46px] w-[46px] cursor-pointer">
